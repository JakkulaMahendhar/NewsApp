package com.appyhigh.newsapp.viewmodel;
...
import com.appyhigh.newsapp.repository.NewsRepository;
...
//    //private void insertData(Article article){
//        repository.new Request().execute(article);
//    }
